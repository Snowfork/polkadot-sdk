...
use crate::XcmRouter;
use crate::{
	xcm_config, xcm_config::UniversalLocation, Balances, EthereumGasPrice, EthereumInboundQueue,
	EthereumOutboundQueue, EthereumSystem, MessageQueue, Runtime, RuntimeEvent, TransactionByteFee,
	TreasuryAccount,
};
use parachains_common::{AccountId, Balance};
use snowbridge_beacon_primitives::{Fork, ForkVersions};
use snowbridge_core::{meth, AllowSiblingsOnly, PricingParameters, Rewards};
...
impl snowbridge_pallet_outbound_queue::Config for Runtime {
	...
	type GasPrice = EthereumGasPrice;
}
